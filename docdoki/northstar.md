...
- A user can conduct normal Pi work through the browser without returning to a separate terminal for the primary conversation loop, while project-scoped shell tabs remain available inside the workbench when direct terminal control is needed.
