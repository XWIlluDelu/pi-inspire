...
- Tool-card and thinking-card visibility preferences are independent. Their selectors run from most to least information: Thinking uses expanded, collapsed, hidden; Tools uses expanded, collapsed, Compact, hidden.
