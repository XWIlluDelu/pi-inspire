...
The user authorized a switchable, transparent Herdr enhancement on 2026-09-25. The RPC-bridge module is an implementation decision for that goal, not a requirement for dual TUI/GUI use or cross-Host process survival. Initial implementation and verification: [[follow-herdr-enhancement-2026-09-25]]. Reviewed failure-path repairs: [[follow-herdr-review-boundaries-2026-09-25]]. Detached-tool ownership and real-Pi stop/crash evidence: [[follow-deep-review-repairs-2026-09-26]]. Herdr's [socket API](https://herdr.dev/docs/socket-api/) supplies the argv layout and metadata interfaces; the initial real integration target is Herdr 0.9.1 / protocol 22.
