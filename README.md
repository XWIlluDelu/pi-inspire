...
- **Typed activity cards.** Thinking and tool activity render as distinguishable cards with file links and status, each independently configurable as hidden, collapsed, or expanded by default.
